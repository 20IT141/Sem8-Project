        ...
        <Routes>
          ...
          {boool ? (
            <Route path="/admin" element={<SidebarOutlet />}>
              <Route
                path="/admin"
                element={boool ? <UserList /> : <SigninAdmin />}
              />
              <Route
                path="/admin/userlist"
                element={boool ? <UserList /> : <NotFound />}
              />
              <Route path="/admin/signin" element={<SigninAdmin />} />
              <Route path="/admin/signup" element={<SignupAdmin />} />
              <Route
                path="/admin/eventpost"
                element={boool ? <PostEvent /> : <NotFound />}
              />
              <Route
                path="/admin/bookedevent"
                element={boool ? <BookedEvent /> : <NotFound />}
              />
              <Route
                path="/admin/postcategory"
                element={boool ? <PostCategory /> : <NotFound />}
              />
            </Route>
          ) : (
            <>
