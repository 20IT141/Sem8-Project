...
import dubai from '../../../assets/images/speaker/Black-White-Dubai-Wallpaper.jpg';
import thumbnail from '../../../assets/images/speaker/speakes-thumbnail.png';
...
const Speaker = () => {
  return (
      <>
		...
		{/* ================================================== --> */}
		<section id="speaker-section" class="speaker-section clearfix" style={{backgroundImage: 'url('+ dubai +')'}}>
							...
							<div class="item">
								<div class="item-content">
									<span class="speaker-thumbnail">
										<img src={thumbnail} alt="Image_not_found"/>
									</span>
