...
const body = JSON.stringify({ password,new_password,confrim_password });

    console.log(data)

const handleClick = async () => {
    if (new_password && password && confrim_password) {
        ...
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
          ...
          >
            ...
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
              ...
              <TextField margin="normal" required fullWidth name="password" label="Password"type="password" id="password" value={password || ''} 
                autoComplete="current-password"
                onChange={(e) => setPassword(e.target.value)}
              />
              <TextField margin="normal" required fullWidth name="password" label="new_password"type="password" id="password" value={new_password || ''} 
                autoComplete="current-password"
                onChange={(e) => setNew_password(e.target.value)}
              />
              <TextField margin="normal" required fullWidth name="password" label="confrim_password"type="password" id="password" value={confrim_password || ''} 
                autoComplete="current-password"
